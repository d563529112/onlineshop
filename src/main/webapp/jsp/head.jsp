...
<%--          <li ><a href="${pageContext.request.contextPath }/jsp/bill.do?method=query">订单管理</a></li>--%>
              ...
              <li><a href="${pageContext.request.contextPath }/jsp/provider.do?method=query">商品管理</a></li>
              <li><a href="${pageContext.request.contextPath }/jsp/user.do?method=query">客户管理</a></li>
